...
class ContractorCategoryPolicy
{
    /**
     * Decontractor::categoryine whether the user can view any models.
     */
    public function viewAny(User $user): bool
    {
        return $user->can('view_any_contractor::category');
    }
    ...
    /**
     * Decontractor::categoryine whether the user can create models.
     */
    public function create(User $user): bool
    {
        return $user->can('create_contractor::category');
    }
