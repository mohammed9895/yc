...
class BittyCashRequestPolicy
{
     ...
     */
    public function view(User $user, BittyCashRequest $bittyCashRequest): bool
    {
     ...
     */
    public function update(User $user, BittyCashRequest $bittyCashRequest): bool
    {
     ...
     */
    public function delete(User $user, BittyCashRequest $bittyCashRequest): bool
    {
     ...
     */
    public function restore(User $user, BittyCashRequest $bittyCashRequest): bool
    {
     ...
     */
    public function forceDelete(User $user, BittyCashRequest $bittyCashRequest): bool
    {
