...
namespace App\Filament\Admin\Resources\PhotographyCompetitions;

use Filament\Schemas\Schema;
use Filament\Actions\Action;
use Filament\Actions\EditAction;
use Filament\Actions\DeleteBulkAction;
use App\Filament\Admin\Resources\PhotographyCompetitions\Pages\ListPhotographyCompetitions;
use App\Filament\Admin\Resources\PhotographyCompetitions\Pages\CreatePhotographyCompetitions;
use App\Filament\Admin\Resources\PhotographyCompetitions\Pages\EditPhotographyCompetitions;
use App\Filament\Admin\Resources\PhotographyCompetitionsResource\Pages;
use App\Filament\Admin\Resources\PhotographyCompetitionsResource\RelationManagers;
...
شكرًا لتسجيلك في مسابقة التصوير الفوتوغرافي. نعتذر عن عدم إجتيازك لمرحلة الفرز.
 نراكم في برامجنا القادمة.')
    ...
    {
        return [
            'index' => ListPhotographyCompetitions::route('/'),
            'create' => CreatePhotographyCompetitions::route('/create'),
            'edit' => EditPhotographyCompetitions::route('/{record}/edit'),
        ];
    }
}
