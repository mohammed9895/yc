...
class EventResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('id')->label(__('id'))->searchable(),
                TextColumn::make('user.name')->sortable()->label(__('user'))->searchable(),
                TextColumn::make('hall.name')->sortable()->label(__('hall'))->searchable(),
                TextColumn::make('title')->label(__('title'))->searchable(),
                TextColumn::make('reasone')->label(__('reasone'))->searchable(),
                TextColumn::make('pax')->label(__('pax')),
                TextColumn::make('start')->sortable()->label(__('start'))->searchable(),
                TextColumn::make('end')->sortable()->label(__('end'))->searchable(),
                TextColumn::make('status')->sortable()->badge()->formatStateUsing(fn ($state) => match ($state) {
                    0 => __('Waiting'),
                    1 => __('Approvied'),
                    2 => __('Rejected'),
                    3 => __('canceled'),
        ...
        return $schema
            ->components([
                ...
                Select::make('hall_id')
                    ...
                    ->searchable()
                    ->required(),
                TextInput::make('pax')->required()->numeric()->label(__('pax'))
            ]);
    }
