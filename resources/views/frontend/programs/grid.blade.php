<section class="py-32">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-10 mt-10 mx-10">
        <div class="bg-white shadow-sm ring-1 ring-black/5 data-[dark]:bg-gray-800 data-[dark]:ring-white/15 p-5 rounded-lg">
            ...
            <h1 class="text-xl">برنامج المهن المستقلة</h1>
            <p class="text-gray-500 text-sm mt-5">يهدف إلى تشجيع الشباب للدخول في العمل الحر واكتشاف مهاراتهم مواهبهم وتطويرها لتكون مصدر دخل لهم  كأصحاب عمل مستقلين، وتعريفهم بالجهود المحلية والدولية في اقتصاد العمل الحر، الفرص الموجودة في السوق ، وكيفية الاستثمار في مهاراتهم المهنية والشخصية.</p>
            <div class="mt-5">
