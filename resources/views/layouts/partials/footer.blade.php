...
{{--<div class="w-full h-[650px]" style="background: url('{{ asset('images/art-wall-website-final.png') }}'); background-repeat: no-repeat; background-size: cover; background-position: top;"></div>--}}
