    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
        @foreach ($workshops as $workshop)
            <div
                ...
                <a wire:click="$dispatch('openModal', {component: 'instructor.attendees-model', arguments: {{ json_encode(['workshop' => $workshop->id], JSON_UNESCAPED_UNICODE) }}})">
                ...
                <div class="p-5">
                    ...
                    <a wire:click="$dispatch('openModal', 'instructor.attendees-model', {{ json_encode(['workshop' => $workshop->id], JSON_UNESCAPED_UNICODE) }})">
