            ...
            <div>
                ...
                <div class="mt-6">
                    <div>
                        ...
                        <input type="text" name="title" id="name" class="mt-1 text-sm bg-slate-100 border-0 rounded-lg px-6 py-4 w-full" placeholder="Title" wire:model="form.title">
                        @error('form.title')
                        <div class="mt-2 text-sm font-medium text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mt-3">
                        <label for="email" class="sr-only">Reason</label>
                        <input type="text" name="reasone" id="reason" class="mt-1 text-sm bg-slate-100 border-0 rounded-lg px-6 py-4 w-full" placeholder="Your Reason" wire:model="form.reasone">
                        @error('form.reasone')
                        <div class="mt-2 text-sm font-medium text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mt-3">
                        ...
                        <input type="text" name="pax" id="pax" class="mt-1 text-sm bg-slate-100 border-0 rounded-lg px-6 py-4 w-full" placeholder="PAX" wire:model="form.pax">
                        @error('form.pax')
                        <div class="mt-2 text-sm font-medium text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
